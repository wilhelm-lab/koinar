...
At the moment Koina mostly focuses on the Proteomics domain but the design can be easily extended to any machine learning model. If you are interested in using Koina to interface with a machine learning model not currently available feel free to [create a request](https://github.com/wilhelm-lab/koina/issues).
...
data = filterMsLevel(data, msLevel = 2) # Filter rawdata for fragmen ion spectra only
...
prosit <- koinar::Koina$new("Prosit_2020_intensity_TMT")
